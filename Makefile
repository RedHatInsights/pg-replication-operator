...
# console.redhat.com/pg-replication-operator-bundle:$VERSION and console.redhat.com/pg-replication-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= console.redhat.com/pg-replication-operator
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name pg-replication-operator-builder
	$(CONTAINER_TOOL) buildx use pg-replication-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm pg-replication-operator-builder
	rm Dockerfile.cross
